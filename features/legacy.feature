...
Feature: ESM legacy service tests
  ...
  Scenario Outline: Attached enable of ESM Legacy services in a ubuntu machine
    ...
    And I verify that `esm-apps-legacy` is enabled
    ...
    And apt-cache policy for the following url has priority `510`
      """
      https://esm.ubuntu.com/apps-legacy/ubuntu <release>-apps-legacy-security/main amd64 Packages
      """
    And apt-cache policy for the following url has priority `510`
      """
      https://esm.ubuntu.com/apps-legacy/ubuntu <release>-apps-legacy-security/main amd64 Packages
    ...
    And stdout matches regexp:
      """
      \s*510 https://esm.ubuntu.com/apps-legacy/ubuntu <release>-apps-legacy-security/main amd64 Packages
      """
